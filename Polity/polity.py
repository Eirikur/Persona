...
POLITY_VERSION = 0.2 # Persona support
        ...
        while True:
            ...
            if msg:
                ...
                if self.doesnt_concern_us(msg):
                    print(f"Not for us: from {msg['from']} our polity {self.polity} our id {self.id}")
                    continue
                self.queue.put(msg)
